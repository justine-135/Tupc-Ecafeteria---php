...
try{
    ...
    $result = $conn->prepare("SELECT * FROM addons_table WHERE item_num='$item_num'");
    $result->execute();
...
<body style="height: auto;" onload="itemFunc()">
    ...
    <form enctype="multipart/form-data" id="item-form" class="was-validated" action="update_addons.php" method="post">
    <div class="container-fluid contents">
        <div class="row">
            <div class="col-sm-3 h-50 d-flex flex-column justify-content-center item-height left-content">
                ...
                <input type="hidden" id='dropdown' value='add-ons'>
            ...
            <div class="col-sm-9 item-height right-content">
                ...
                <div class="itemMenu container-fluid">  
                    <div id="accordion">
                        ...
                        <div class="container-fluid addOns show" id="itemAddons" data-parent="#accordion">
...
submitForm.addEventListener('submit', function(e){// submit items
  ...
  addBtn.addEventListener('click', () =>{
    ...
    Add this item to: <h6 class='popup'>add-ons</h6>  <hr>
